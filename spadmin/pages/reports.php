          ...
          <div class="card-body">
            ...
            <ul class="nav nav-tabs nav-tabs-bordered d-flex" id="borderedTabJustified" role="tablist">
              <li class="nav-item flex-fill" role="presentation">
                <button class="nav-link w-100 active" id="tsd-tab" data-bs-toggle="tab" data-bs-target="#tsd-justified" type="button" role="tab" aria-controls="tsd" aria-selected="true">Minutes of the </button>
              </li>
              <li class="nav-item flex-fill" role="presentation">
